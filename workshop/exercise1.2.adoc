...
----
ansible-playbook --private-key=~/.ssh/tysons-tower -i ../hosts install_apache.yml
----
====
...
----
ansible-playbook --private-key=~/.ssh/tysons-tower -i ../hosts install_apache.yml --syntax-check
----
